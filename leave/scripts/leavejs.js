...
var UILeaveApply = new Class({
    ...
    createLeaveDetailsGroup: function (formData) {
        ...
        //Row4 Columns
        this.leaveDetailsRow4Column1 = new Element('span', { 'class': 'leave-apply-group-column-blank-container-for-attachment' }).inject(this.leaveDetailsGroupRow4);
        ...
        //Row6 Columns
        this.leaveDetailsRow6Column1 = new Element('span', { 'class': 'leave-apply-group-column-blank-container' }).inject(this.leaveDetailsGroupRow6);
        ...
        this.attachment = new Element('div', { 'class': 'form-row leave-apply-attachment leave-apply-attachment-form' }).inject(this.leaveDetailsRow4Column2);
...
var UILeaveDetail = new Class({
    ...
    createLeaveDetailsStatusArea: function (container) {
        ...
        var approver = this.data.Components[0].Authorisation.SubmittedToName;
    ...
    showErrorMessages: function (errorMessages) {
        if (document.getElement('.messages')) {
            ...
            for (var i = 0; i < errorMessages.length; i++) {
                var errorMessage = errorMessages[i] + '<br>';
    ...
    applyFormattingRule: function (fieldElement, formattingRule, ruleParams) {
        if (formattingRule.toFormatIn2DecimalPlaces) {
            fieldElement.value = parseFloat(fieldElement.value).toFixed(2);
        }
    ...
    createDaysRulesObject: function () {
        ...
        rulesObject.setValueBasedOnHours = function (fieldElement, rulesParams) {
            ...
            if (!isNaN(daysValue) && parseFloat(daysValue) >= 0 && daysValue !== Infinity) {
                ...
                fieldElement.value = parseFloat(daysValue).toFixed(2);
