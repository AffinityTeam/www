                ...
                if (leave.StatusCode !== -1) {
                    ...
                    this.approveButton.addEvent('click', function () {
                        ...
                        this.data.Components[0].Units.forEach(function(data, index) {
                            var a = this.leavePeriodDaysContainer.getElementById('period-dayexceeds-warning-' + index);

                            if (a.get('text') === 'Hours exceeds Scheduled amount') {
...
var InputEditWidget = new Class({
    ...
    initialize: function (options) {
        ...
        this.doOnSelect = this.options.doOnSelect;
        this.selected = false;
